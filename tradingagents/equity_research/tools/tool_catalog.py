...
EQUITY_TOOLS_CATEGORIES: dict[str, CategorySpec] = {
    ...
    "search": {
        ...
        "tools": {
            ...
            "search_web": {"description": "Legacy web search stub", "inputs": ["query"], "risk": "low"},
    ...
    "finance": {
        ...
        "tools": {
            ...
            "filings_search": {"description": "Search SEC filings", "inputs": ["ticker", "form_type"], "risk": "low"},
            ...
            "get_financial_statements": {"description": "Legacy financial statements bundle", "inputs": ["ticker"], "risk": "low"},
            "get_consensus_estimates": {"description": "Legacy consensus estimates", "inputs": ["ticker"], "risk": "low"},
            "get_current_price": {"description": "Current stock price briefing", "inputs": ["ticker"], "risk": "low"},
            "get_news": {"description": "Ticker news feed", "inputs": ["ticker"], "risk": "low"},
            "search_company_filings": {"description": "Search company filings", "inputs": ["ticker"], "risk": "low"},
    ...
    "data": {
        ...
        "tools": {
            ...
            "calculate_cagr": {"description": "Calculate CAGR", "inputs": ["values", "periods"], "risk": "low"},
            "calculate_total_return": {"description": "Calculate total return", "inputs": ["price_upside_pct"], "risk": "low"},
            "calculate_trading_multiple_valuation": {"description": "Trading multiple valuation", "inputs": ["ticker"], "risk": "low"},
            "calculate_sensitivity_table": {"description": "Sensitivity table", "inputs": ["base_target", "scenarios"], "risk": "low"},
