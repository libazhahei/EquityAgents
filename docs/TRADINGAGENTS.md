> **This repository root [README.md](../README.md) documents the Equity Research (R&D-Agent) workflow.**
> This page preserves the upstream TradingAgents multi-agent **trading framework** documentation.
>
> 中文版 | [docs/zh/TRADINGAGENTS.md](zh/TRADINGAGENTS.md)
